<div class="landing container-fluid text-center m-0 p-0">
            ...
            <div class="row flex-nowrap">
                <?php if ($result->num_rows > 0): ?>
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <div class="featuredItem p-4 border-gray col-12 col-sm-6 col-md-4 col-lg-3">
                            <div class="row">
...
<section class="aboutus py-5" id="Aboutus">
    <div class="container-fluid">
        <div class="row align-items-stretch">
            ...
            <div class="col-md-6 d-flex flex-column justify-content-between justify-text justify-text-end p-5">
                <div class="aboutusdesc ps-5">
                    <p class="fs-5">At Weltz Industrial Philippines Inc., we don't just sell fire protection supplies, we provide peace of mind.
                ...
                <div class="aboutusdesc ps-5">
                    <p class="fs-5">Choose Weltz Industrial Philippines Inc. for reliable, innovative, and cost-effective fire protection solutions.
                        Because when it comes to safety, you deserve nothing but the best.
                    </p>
                </div>

                <div class="aboutusdesc ps-5">
                    <p class="fs-4 fw-bold">Protect what matters most with Weltz Industrial Philippines Inc.</p>
                </div>
            </div>
...
<section class="trustedpartners text-white py-5" style="background-color: #fc0001;">
    <div class="container">
        <!-- Trusted Partners Title -->
        <div class="tptitle text-center mb-5">
            <h1 class="display-4"><strong>Trusted Partners</strong></h1>
        </div>
