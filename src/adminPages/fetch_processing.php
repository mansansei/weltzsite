...
if (empty($orders)): ?>
    <p class="text-center">No matching orders found.</p>
<?php else: ?>
            ...
            <div class="order-footer row align-items-center p-3 m-0 border-top border-dark">
                ...
                <div class="row p-1 m-0 d-flex justify-content-end">
                    ...
                    <div class="col-lg-6 text-end">
                        <button class="btn btn-warning edit-order-btn" data-bs-toggle="modal" data-bs-target="#editOrderToPickUpModal" data-order-id="<?= $orderID ?>">Edit Order</button>
                    </div>
                </div>
            </div>
        </div>
