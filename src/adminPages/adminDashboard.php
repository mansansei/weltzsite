<section class="mema">
    <div class="memabox1">
        ...
        <div class="total-sales-box d-flex align-items-center p-2 rounded h-100">
    ...
    <div class="memabox2">
        ...
        <div class="total-stock-box d-flex align-items-center p-2 rounded h-100">
            <div class="me-3 d-flex align-items-center justify-content-center">
    ...
    <div class="memabox3">
        ...
        <div class="total-users-box d-flex align-items-center p-2 rounded h-100 justify-content-start">
            <div class="me-3 d-flex align-items-center justify-content-center">
    ...
    <div class="memabox4">
        ...
        <div class="most-sales-box d-flex align-items-center p-2 rounded h-100">
            <div class="me-3 d-flex align-items-center justify-content-center">
