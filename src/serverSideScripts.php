...
function addProduct()
{
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $productSpecs = isset($_POST['prodSpecs']) ? $_POST['prodSpecs'] : '';
    ...
    $insertsql = "INSERT INTO products_tbl (userID, productName, productIMG, categoryID, productDesc, productPrice, inStock, productSpecs, prodSold, createdAt, updatedAt)
                      VALUES ('$userID', '$productName', '$productIMGPath', '$categoryID', '$productDesc', '$productPrice', '$inStock', '$productSpecs', 0, '$currentDateTime', '$currentDateTime')";
    ...
    if ($conn->query($insertsql) === TRUE) {
      ...
      $newValues = json_encode(['userID' => $userID, 'productName' => $productName, 'productIMG' => $productIMGPath, 'categoryID' => $categoryID, 'productDesc' => $productDesc, 'productPrice' => $productPrice, 'inStock' => $inStock, 'productSpecs' => $productSpecs]);
